...
float tc8() { // write on RO, invalid page
#define MARKS_EXPL "tc8: Write on unknown segment - Give 0.5 marks if this process terminates with an error\n"
#define RO_TEST_FAIL "tc8: Write on unknown segment test failed. Give 0 marks\n"
  float marks = 0;
  int ret;
...
static int main()
{
  ...
  i = *ptr;
#endif
  char marks_str[][18] = {"tc08 marks = 0.0\n", "tc08 marks = 0.5\n", "tc08 marks = 1.0\n"};
